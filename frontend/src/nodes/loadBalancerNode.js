...
export const LoadBalancerNode = ({id, data}) => {
    ...
    const body = (
        ...
        <>
            <div className="node-icon" style={{position: "absolute", top: "-40px", left:"140px"}}>
                <svg width="80px" height="80px" viewBox="0 0 100 100" version="1.1">                  
